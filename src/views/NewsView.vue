...
<template>
    <div class="bg-white py-12 sm:pt-20 sm:pb-15 sm:px-10 rounded-xl">
                ...
                <div class="lg:pr-4">
                    <div class="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
                        <img class="absolute inset-0 h-full w-full object-cover brightness-125 saturate-0"
                             src="https://images.unsplash.com/photo-1630569267625-157f8f9d1a7e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2669&q=80" alt=""
                        />
...
<!--                        link to orig source-->
                        <a href="#" class="text-base font-semibold leading-7 text-indigo-600">Learn more from original source <span aria-hidden="true">&rarr;</span></a>
                    </div>
                </div>
            </div>
        </div>
